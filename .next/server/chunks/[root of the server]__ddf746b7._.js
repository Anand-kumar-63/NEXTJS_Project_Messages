...
"[project]/src/app/lib/verificationemail.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/helpers/sendverificationemail.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$verificationemail$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/lib/verificationemail.ts [app-route] (ecmascript)");
;
;
async function SendVerificationEmail(Email, username, verificationcode) {
    try {
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$verificationemail$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["resend"].emails.send({
        ...
        return {
            success: true,
            message: "verification code is send succesfully"
        };
    } catch (error) {
...
"[project]/src/app/helpers/Verifyuser.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$user$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/models/user.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/bcryptjs/index.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$helpers$2f$sendverificationemail$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/helpers/sendverificationemail.ts [app-route] (ecmascript)");
;
;
;
;
async function VerifyUser(userdata) {
    ...
    try {
        ...
        const findinguserverifiedusingusername = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$user$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            username,
            isVerified: true
        });
        ...
        const verifyuserusingEmail = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$user$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            email
        });
        const verifycode = Math.floor(10000 + Math.random() * 90000).toString();
        if (verifyuserusingEmail) {
            ...
            const hashpawword = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(password, 10);
            const expiryDate = new Date();
            expiryDate.setHours(expiryDate.getHours() + 1);
            const Newuser = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$user$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]({
                username: username,
                email: email,
        ...
        const Emailresponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$helpers$2f$sendverificationemail$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SendVerificationEmail"])(username, verifycode, email);
...
"[project]/src/app/api/auth/[...nextauth]/options.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$helpers$2f$Verifyuser$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/helpers/Verifyuser.ts [app-route] (ecmascript)");
;
;
;
;
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                ...
                try {
                    ...
                    const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$user$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
                        $or: [
                            {
                                email: identifier
                            },
                    ...
                    if (!user) {
                        ...
                        const newuser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$helpers$2f$savenewuser$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveuser"])(mockrequest);
                        console.log(newuser);
                        return newuser;
                    }
                    if (!user.isverified) {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$helpers$2f$Verifyuser$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["VerifyUser"])({
                            username: credentials.username,
                            password: credentials.password,
                            email: credentials.email
                        });
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$auth$2f5b2e2e2e$nextauth$5d2f$options$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/api/auth/[...nextauth]/options.ts [app-route] (ecmascript)");
;
;
const handler = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$auth$2f5b2e2e2e$nextauth$5d2f$options$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authOptions"]);
;
}}),

};

//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ddf746b7._.js.map